...
> 版本：skill v3.11.0 / annotation schema 2.10.0 / aggregation schema 3.1.0（决策 22 三域解耦）
...
## 九、PowerShell 编码与 batch 合并工作流（v3.11.0 新增）
...
4. **annotate_segment.py v3.11.0 起会自动警告**：doc_id 包含非 ASCII 字符时打印提醒
